...
ppdeconv <- function(a0 = NULL, data, mode = "mle"){
  ...
  if(mode == "mle"){
    ...
    fn <- function(p) loglik(p, y = data_bdiag$y, Q = data_bdiag$Q, P = data_bdiag$P, S = data_bdiag$S, c0 = data_bdiag$c0)
    gr <- function(p) gradient(p, y = data_bdiag$y, Q = data_bdiag$Q, P = data_bdiag$P, S = data_bdiag$S, c0 = data_bdiag$c0)
    ...
    fit <- stats::optim(par = a0, fn = fn, gr = gr, method = "BFGS",
